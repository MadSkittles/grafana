...
type HTTPServer struct {
	...
	joinRequestService   join_requester.Service
...
func ProvideHTTPServer(opts ServerOptions, cfg *setting.Cfg, routeRegister routing.RouteRegister, bus bus.Bus,
	...
	starApi *starApi.API, promRegister prometheus.Registerer, clientConfigProvider grafanaapiserver.DirectRestConfigProvider, anonService anonymous.Service, joinRequestService join_requester.Service,
) (*HTTPServer, error) {
	web.Env = cfg.Env
	m := web.New()
